...
data class RigidTransform(
    ...
    companion object {
        fun getTransform(src: Rect, dst: Rect, useTopLeftGravity: Boolean = true, forceScale: Float? = null): RigidTransform {
            val scaleX = dst.width / src.width
            val scaleY = dst.height / src.height
            val scale = forceScale ?: maxOf(scaleX, scaleY)
...
fun Rect.getTransformTo(dst: Rect, forceScale: Float? = null): RigidTransform = RigidTransform.getTransform(this, dst, useTopLeftGravity = true, forceScale)
